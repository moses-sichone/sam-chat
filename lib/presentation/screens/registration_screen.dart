...
import 'package:samchat/data/model/user_model.dart';
...
import 'package:samchat/presentation/pages/phone_varification_page.dart';
import 'package:samchat/presentation/pages/set_initial_profile_page.dart';
import 'package:samchat/presentation/screens/home_screen.dart';
...
class _RegistrationScreenState extends State<RegistrationScreen> {
  static Country _selectedFilteredDialogCountry =
      CountryPickerUtils.getCountryByPhoneCode("260");
      ...
      body: Container(
        ...
        child: Column(
          children: <Widget>[
            ...
            Text(
              "SamChat will send and SMS message (carrier charges may apply) to verify your phone number. Enter your country code and phone number:",
              style: TextStyle(
                fontSize: 16,
              ),
            ),
